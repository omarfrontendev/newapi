...
export default function Privacy() {
  return (
    <div className={styles.privacy}>
      ...
      <a class="wpembed-inline" href="https://app.websitepolicies.com/policies/view/gz4nisna">Privacy policy</a><script src="https://cdn.websitepolicies.io/lib/embed/embed.min.js" defer></script>
      <h3 className={styles.privacy__title}>Privacy policy</h3>
      <p>We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the <a href='https://www.pick-a.net/' target='_blank'>pick-a.net</a> website (“Website”), “Pick A” mobile application (“Mobile Application”), and any of their related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.
      This Policy is a legally binding agreement between you (“User”, “you” or “your”) and Pick A Delivery Service L.L.C (“Pick A Delivery Service L.L.C”, “we”, “us” or “our”). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Services. By accessing and using the Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.
      </p>
      <h3 className={styles.privacy__title}>Automatic collection of information</h3>
      <p>
      ...
      <h3 className={styles.privacy__title}>Collection of personal information</h3>
      <p>
      ...
      <h3 className={styles.privacy__title}>Use and processing of collected information</h3>
      ...
      <p>Our Services use “cookies” to help personalize your online experience. A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be used to run programs or deliver viruses to your computer. Cookies are uniquely assigned to you, and can only be read by a web server in the domain that issued the cookie to you. If you choose to decline cookies, you may not be able to fully experience the features of the Services. You may learn more about cookies and how they work <a href="https://www.websitepolicies.com/blog/sample-cookie-policy-template" target='_blank'>here.</a></p>
      ...
      <p>
      <a href="https://app.websitepolicies.com/dsar/view/6ak6v4jr" target='_blank'>Submit a data access request</a><br/>
      ...
      <p>
        <a href="mailto:info@pick-a.net" target='_blank'>info@pick-a.net</a><br/>
        1906 Latifa Tower World Trade 1 Sheik Zayed Road, Dubai United Arab Emirates
        Data protection officer: John
        john@pick-a.net
      </p>
      <p>
